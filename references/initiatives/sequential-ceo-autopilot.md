...
closed `runTaskCandidate` object, without executing `run_task`. The next safe
step is exactly one ready slice: S13 dogfood of S12 preflight reports against
committed TaskSpec candidates without executing `run_task`.
